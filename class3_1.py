# -*- coding: utf-8 -*-
"""
Created on Sat Jul  9 17:36:49 2022
...
def exer(*args,name): #이렇게 하면 실행 안 됨
    print(name)
    print(len(args))
    print(type(args))
exer(1,2,3,"이상훈") #이렇게 해도 실행 안 됨
...
class squid_game:
    def __init__(self, *args): #튜플로 받는데, 튜플은 참가자 명단이다.
        self.data = list(args)[0] #튜플을 리스토 바꿔줌
...
a = first_comp.check()
import random
first_dead_list = random.sample(first_list,10) #랜덤하게 10명 뽑음
...
class cal :
    ...
    def add(self,num1,num2) :
        result = num1 + num2
        print("두 수의 합은 {}입니다.".format(result))
        
    def sub(self,num1,num2) :
        result = num1 - num2
        print("두 수의 차는 {}입니다.".format(result))
