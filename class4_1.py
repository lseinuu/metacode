# -*- coding: utf-8 -*-
"""
Created on Mon Jul 11 21:30:34 2022
...
f = open('C:/Users/이세인/OneDrive/바탕 화면/metacode-python/coin.txt','r',encoding='utf8')
line = f.readlines()
f.close()
...
# 예외처리 구문에서 pass와 continue의 차이점을 서술하시오
 ...
 예외처리 구문에서 pass를 만나면 그 다음 코드를 계속 진행하면 되고,
 예외처리 구문에서 continue를 만나면 다음 코드 실행이 아닌 그 다음 루프를 실행하면 된다.      
